...
const jsonRpcProviders = {
  // https://evm-rpc.arctic-1.seinetwork.io/ will work?
  [`WEB3_RPC_${ChainId.SEIDEV}`]: process.env.JSON_RPC_PROVIDER_SEIDEV!,
}

Object.entries(jsonRpcProviders).forEach(([k,v]) => {
